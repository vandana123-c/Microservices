...
public class DashboardController {
    ...
    @Autowired
    private reactiveCircuitBreakerFactory breaker;
...
reactivecircuitbraker rc= new breaker.create("tollrate-rb");


       Mono<TollRate> rate =rc.run(webClientBuilder.build().get()
    ...
    System.out.println("fallbach method call");

       return Mono.just(new TollRate(0,2.4f,""));
